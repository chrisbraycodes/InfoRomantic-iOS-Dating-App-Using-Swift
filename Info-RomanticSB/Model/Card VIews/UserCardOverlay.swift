...
class UserCardOverlay: UIView {
    ...
    private func createLeftOverlay() {
        let leftTextView = SampleOverlayLabelView(withTitle: "Not Interested.", color: .sampleBlue, rotation: CGFloat.pi/10)
    ...
    private func createRightOverlay() {
        let rightTextView = SampleOverlayLabelView(withTitle: "Yes Please", color: .samplePink, rotation: -CGFloat.pi/10)
